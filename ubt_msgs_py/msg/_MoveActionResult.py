...
"""autogenerated by genpy from ubt_msgs/MoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveActionResult(genpy.Message):
  ...
  _type = "ubt_msgs/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ubt_msgs/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ubt_msgs.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ubt_msgs.msg.MoveResult()
