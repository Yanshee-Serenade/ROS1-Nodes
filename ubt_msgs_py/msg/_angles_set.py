...
"""autogenerated by genpy from ubt_msgs/angles_set.msg. Do not edit."""
import codecs
import sys
...
class angles_set(genpy.Message):
  _md5sum = "623f51b9e6473cd45146c578471ed248"
  _type = "ubt_msgs/angles_set"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32[] angles
int32 time
"""
  __slots__ = ['angles','time']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(angles_set, self).__init__(*args, **kwds)
